...
const QuestionDetail = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="text-gray-700 mb-4" dangerouslySetInnerHTML={{ __html: question.description }} />
      <div className="flex gap-2 mb-6">
        {question.tags.map((tag, idx) => (
          <span key={idx} className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-sm">
            #{tag}
          </span>
        ))}
      </div>
